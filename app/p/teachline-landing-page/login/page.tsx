...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (errors === "" && formData.username.trim() !== "") {
      ...
      setIsLoading(false);
      if (response.status === 307) router.push(`/p/teachline-landing-page/${jsonData.url}`);
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-white dark:bg-black dark:text-white text-black">
